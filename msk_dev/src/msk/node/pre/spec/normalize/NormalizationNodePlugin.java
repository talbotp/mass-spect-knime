 ...
 */
public class NormalizationNodePlugin extends Plugin {
    // The shared instance.
    private static NormalizationNodePlugin plugin;

    /**
     * The constructor.
     */
    public NormalizationNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static NormalizationNodePlugin getDefault() {
        return plugin;
    }
