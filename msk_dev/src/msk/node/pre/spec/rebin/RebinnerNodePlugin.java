 ...
 */
public class RebinnerNodePlugin extends Plugin {
    // The shared instance.
    private static RebinnerNodePlugin plugin;

    /**
     * The constructor.
     */
    public RebinnerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static RebinnerNodePlugin getDefault() {
        return plugin;
    }
