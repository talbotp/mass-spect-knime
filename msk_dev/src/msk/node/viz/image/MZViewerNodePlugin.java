 ...
 */
public class MZViewerNodePlugin extends Plugin {
    // The shared instance.
    private static MZViewerNodePlugin plugin;

    /**
     * The constructor.
     */
    public MZViewerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MZViewerNodePlugin getDefault() {
        return plugin;
    }
