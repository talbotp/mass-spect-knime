 ...
 */
public class SpectrumJPEGNodePlugin extends Plugin {
    // The shared instance.
    private static SpectrumJPEGNodePlugin plugin;

    /**
     * The constructor.
     */
    public SpectrumJPEGNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SpectrumJPEGNodePlugin getDefault() {
        return plugin;
    }
