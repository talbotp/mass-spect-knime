 ...
 */
public class MeanBasepeakSpectrumNodePlugin extends Plugin {
    // The shared instance.
    private static MeanBasepeakSpectrumNodePlugin plugin;

    /**
     * The constructor.
     */
    public MeanBasepeakSpectrumNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MeanBasepeakSpectrumNodePlugin getDefault() {
        return plugin;
    }
