 ...
 */
public class SpectrumViewNodePlugin extends Plugin {
    // The shared instance.
    private static SpectrumViewNodePlugin plugin;

    /**
     * The constructor.
     */
    public SpectrumViewNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SpectrumViewNodePlugin getDefault() {
        return plugin;
    }
