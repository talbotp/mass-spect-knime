 ...
 */
public class ClusterViewerNodePlugin extends Plugin {
    // The shared instance.
    private static ClusterViewerNodePlugin plugin;

    /**
     * The constructor.
     */
    public ClusterViewerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ClusterViewerNodePlugin getDefault() {
        return plugin;
    }
