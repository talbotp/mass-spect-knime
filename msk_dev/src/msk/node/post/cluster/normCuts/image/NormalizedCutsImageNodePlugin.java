 ...
 */
public class NormalizedCutsImageNodePlugin extends Plugin {
    // The shared instance.
    private static NormalizedCutsImageNodePlugin plugin;

    /**
     * The constructor.
     */
    public NormalizedCutsImageNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static NormalizedCutsImageNodePlugin getDefault() {
        return plugin;
    }
