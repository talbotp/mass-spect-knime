 ...
 */
public class NormalizedCutsNodePlugin extends Plugin {
    // The shared instance.
    private static NormalizedCutsNodePlugin plugin;

    /**
     * The constructor.
     */
    public NormalizedCutsNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static NormalizedCutsNodePlugin getDefault() {
        return plugin;
    }
