 ...
 */
public class CombinerNodePlugin extends Plugin {
    // The shared instance.
    private static CombinerNodePlugin plugin;

    /**
     * The constructor.
     */
    public CombinerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CombinerNodePlugin getDefault() {
        return plugin;
    }
