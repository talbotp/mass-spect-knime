 ...
 */
public class ImzMLProcessedLoopStartNodePlugin extends Plugin {
    // The shared instance.
    private static ImzMLProcessedLoopStartNodePlugin plugin;

    /**
     * The constructor.
     */
    public ImzMLProcessedLoopStartNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ImzMLProcessedLoopStartNodePlugin getDefault() {
        return plugin;
    }
