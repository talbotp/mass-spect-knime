 ...
 */
public class ImzMLChunkReaderRowSpectrumNodePlugin extends Plugin {
    // The shared instance.
    private static ImzMLChunkReaderRowSpectrumNodePlugin plugin;

    /**
     * The constructor.
     */
    public ImzMLChunkReaderRowSpectrumNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ImzMLChunkReaderRowSpectrumNodePlugin getDefault() {
        return plugin;
    }
