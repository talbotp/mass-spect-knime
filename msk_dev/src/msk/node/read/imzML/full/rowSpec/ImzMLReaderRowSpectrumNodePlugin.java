 ...
 */
public class ImzMLReaderRowSpectrumNodePlugin extends Plugin {
    // The shared instance.
    private static ImzMLReaderRowSpectrumNodePlugin plugin;

    /**
     * The constructor.
     */
    public ImzMLReaderRowSpectrumNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ImzMLReaderRowSpectrumNodePlugin getDefault() {
        return plugin;
    }
