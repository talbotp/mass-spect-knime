 ...
 */
public class IonImageLoopStartNodePlugin extends Plugin {
    // The shared instance.
    private static IonImageLoopStartNodePlugin plugin;

    /**
     * The constructor.
     */
    public IonImageLoopStartNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static IonImageLoopStartNodePlugin getDefault() {
        return plugin;
    }
