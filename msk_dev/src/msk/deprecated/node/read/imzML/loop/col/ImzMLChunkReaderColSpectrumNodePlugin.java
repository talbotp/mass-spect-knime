 ...
 */
public class ImzMLChunkReaderColSpectrumNodePlugin extends Plugin {
    // The shared instance.
    private static ImzMLChunkReaderColSpectrumNodePlugin plugin;

    /**
     * The constructor.
     */
    public ImzMLChunkReaderColSpectrumNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ImzMLChunkReaderColSpectrumNodePlugin getDefault() {
        return plugin;
    }
