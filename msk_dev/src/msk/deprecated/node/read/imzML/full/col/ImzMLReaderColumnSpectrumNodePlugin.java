 ...
 */
public class ImzMLReaderColumnSpectrumNodePlugin extends Plugin {
    // The shared instance.
    private static ImzMLReaderColumnSpectrumNodePlugin plugin;

    /**
     * The constructor.
     */
    public ImzMLReaderColumnSpectrumNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ImzMLReaderColumnSpectrumNodePlugin getDefault() {
        return plugin;
    }
