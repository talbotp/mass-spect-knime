 ...
 */
public class BuildFakeImzMLNodePlugin extends Plugin {
    // The shared instance.
    private static BuildFakeImzMLNodePlugin plugin;

    /**
     * The constructor.
     */
    public BuildFakeImzMLNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static BuildFakeImzMLNodePlugin getDefault() {
        return plugin;
    }
